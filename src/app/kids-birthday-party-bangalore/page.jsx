...
const pageConfig = {
  ...
  pricing: [
    {
      name: 'Starter',
      subtitle: 'Perfect for intimate kids parties',
      price: 15000,
      featured: false,
      includes: [
        'Theme balloon arch & backdrop',
        'Birthday name banner',
        'Basic prop & floor décor',
        'Cleanup & support',
        'Up to 30 kids + parents',
      ],
    },
    {
      name: 'Premium',
      subtitle: 'Our most popular kids party package',
      price: 38000,
      featured: true,
      includes: [
        'Full theme décor & execution',
        'Themed cake coordination',
        'Magician or entertainer (1.5 hrs)',
        'Photography (2 hours)',
        'Party games & activity corner',
        'Themed stationery & favour bags',
        'Up to 60 kids + parents',
      ],
    },
    {
      name: 'Luxury',
      subtitle: 'Epic kids party experience',
      price: 80000,
      featured: false,
      includes: [
        'Bespoke theme full styling',
        'Multiple entertainment acts',
        'Bounce house / play zone',
  ...
  faqs: [
    {
      question: 'How much does a kids birthday party cost in Bangalore?',
      answer:
        'Kids birthday parties in Bangalore start from ₹15,000 for basic themed décor, up to ₹80,000 for full entertainment packages with magicians, bounce houses and catering coordination.',
    },
    {
      question: 'What entertainment can Eevagga arrange for kids?',
      answer:
        'We arrange magicians, clowns, face painters, balloon artists, puppet shows, game hosts, bubble machines and bounce houses — guaranteed to keep every child entertained.',
    },
    {
      question: 'Which kids themes are most popular in Bangalore?',
      answer:
        'Top themes are Cocomelon, unicorn, jungle safari, Barbie, superhero, princess, space, Paw Patrol and Boss Baby. We specialise in all of them with custom props and décor.',
    },
    {
      question: 'Does Eevagga plan home birthday parties for kids?',
      answer:
        'Yes! We are specialists in at-home kids parties across Bangalore. Our team handles everything — setup, entertainment management and full teardown — so parents can simply enjoy the day.',
    },
    {
      question: 'How far in advance should I book a kids birthday party?',
      answer:
        'We recommend 2–3 weeks in advance. For weekend parties and popular themes, 4 weeks ensures all entertainers, props and photography slots are secured.',
    },
  ],
};
